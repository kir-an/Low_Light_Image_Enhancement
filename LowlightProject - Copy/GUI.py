...
def upload():
    ...
    os.chdir(r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\data\test_data\images")
...
def lowlight(image_path):
    ...
    DCE_net.load_state_dict(torch.load(r'C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\snapshots\Epoch99.pth', map_location={'cuda:0': 'cpu'}))
    start = time.time()
    ...
    torchvision.utils.save_image(enhanced_image, r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\data\result\images\output.jpg")
    imagePath2 = (r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\data\result\images\output.jpg") #image path
...
# test_images
    with torch.no_grad():
        ...
        test_list = glob.glob(r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\data\test_data\images\*") 
        for image in test_list:
            print(image)
            lowlight(image)

def savefile():
    imagePath3 = (r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\data\result\images\output.jpg") #image path
...
icon_img = ImageTk.PhotoImage(Image.open(r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\download.png"))
...
ai_image = ImageTk.PhotoImage(Image.open(r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\index.jpg"))
Label(right_frame, image=ai_image).grid(row=0,column=0, padx=3, pady=3)

a_image = ImageTk.PhotoImage(Image.open(r"C:\Users\CHARISH PATEL M N\Desktop\Afinal year projects\LowlightProject\index.jpg"))
